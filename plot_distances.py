...
if __name__ == '__main__':
    ...
    for i, city in enumerate(cities, 0):
        ...
        if city in capitals:
            ...
            central_bfs = nf.load_json('results/' + city + '/distance_analysis/json/capital_bfs_central.json')
            central_eu = nf.load_json('results/' + city + '/distance_analysis/json/capital_eu_central.json')
            datavecs = [list(central_bfs.values()), list(central_eu.values())]
